...
(async () => {
  const client = new MeiliSearch({
    host: "https://app-meilisearchformosadict-dev-001.azurewebsites.net",
  });
...
const searchClient = instantMeiliSearch("https://app-meilisearchformosadict-dev-001.azurewebsites.net", {
